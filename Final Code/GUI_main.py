...
bg = Image.open("download2.jpg")

#bg.resize((1366,200),Image.LANCZOS)
# print(w,h)
...
canvas.pack()
text_var="Driver face recognition"
...
# w = tk.Label(root, text="Oral_cancer_detection",background="#17202A",foreground="white",font=("Times new roman",19,"bold"))
...
# wlcm=tk.Label(root,text="Military Vehicle Detection",font=("Roboto",22,"bold"),bg='white',)
# wlcm.place(x=300,y=270)




d2=tk.Button(root,text="Login",command=Login,width=20,height=2,bd=0,background="#d35400",foreground="white",font=("times new roman",14,"bold"))
d2.place(x=1100,y=350)


d3=tk.Button(root,text="Register",command=Register,width=20,height=2,bd=0,background="#d35400",foreground="white",font=("times new roman",14,"bold"))
