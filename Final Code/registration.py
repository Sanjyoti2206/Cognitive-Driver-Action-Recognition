...
image2 = Image.open('img66.jpg')
image2 = image2.resize((1800, 900), Image.LANCZOS)
...
l2 = tk.Label(window, text="Full Name :", width=14, font=("Times new roman", 15), bg="black", fg="white")
...
l3 = tk.Label(window, text="Address :", width=14, font=("Times new roman", 15, "bold"), bg="black", fg="white")
...
l5 = tk.Label(window, text="E-mail :", width=14, font=("Times new roman", 15, "bold"), bg="black", fg="white")
l5.place(x=465, y=250)
t4 = tk.Entry(window, textvar=Email, width=35, font=('', 15))
t4.place(x=700, y=250)
# that is for email address

l6 = tk.Label(window, text="Phone number :", width=14, font=("Times new roman", 15, "bold"), bg="black", fg="white")
l6.place(x=465, y=300)
t5 = tk.Entry(window, textvar=Phoneno, width=35, font=('', 15))
t5.place(x=700, y=300)
# phone number
l7 = tk.Label(window, text="Gender :", width=14, font=("Times new roman", 15, "bold"), bg="black", fg="white")
l7.place(x=465, y=350)
# gender
tk.Radiobutton(window, text="Male", padx=5, width=10, bg="white", font=("bold", 15), variable=var, value=1).place(x=700,
                                                                                                                y=350)
tk.Radiobutton(window, text="Female", padx=20, width=12, bg="white", font=("bold", 15), variable=var, value=2).place(
    x=880, y=350)

l8 = tk.Label(window, text="Age :", width=14, font=("Times new roman", 15, "bold"), bg="black", fg="white")
l8.place(x=465, y=400)
t6 = tk.Entry(window, textvar=age, width=35, font=('', 15))
t6.place(x=700, y=400)

l4 = tk.Label(window, text="User Name :", width=14, font=("Times new roman", 15, "bold"), bg="black", fg="white")
l4.place(x=465, y=450)
t3 = tk.Entry(window, textvar=username, width=35, font=('', 15))
t3.place(x=700, y=450)

l9 = tk.Label(window, text="Password :", width=14, font=("Times new roman", 15, "bold"), bg="black", fg="white")
l9.place(x=465, y=500)
t9 = tk.Entry(window, textvar=password, width=35, font=('', 15), show="*")
t9.place(x=700, y=500)

l10 = tk.Label(window, text="Confirm Password:", width=14, font=("Times new roman", 15, "bold"), bg="black", fg="white")
